...
public class BlackholeKnifeProjectileModel extends EntityModel<BlackholeKnifeProjectileEntity> {
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(VoidWeaponry.MOD_ID, "blackhole_knife"), "main");
    private final ModelPart dagger;

    public BlackholeKnifeProjectileModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(BlackholeKnifeProjectileEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
